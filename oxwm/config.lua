...
local colors = {
    ...
    cyan = "#8ec07c",        -- 青色（偏绿）
    green = "#b8bb26",       -- 绿色
    lavender = "#d3869b",    -- 薰衣草色（粉色）
    light_blue = "#83a598",  -- 浅蓝色（青色调）
    grey = "#928374",        -- 灰色
    blue = "#458588",        -- 蓝色
    purple = "#b16286",      -- 紫色（粉色调）
    orange = "#fe8019",      -- 橙色
    yellow = "#fabd2f",      -- 建议添加的黄色
}
...
oxwm.key.bind({ "Mod4" }, "M", oxwm.quit())
...
oxwm.key.bind({ modkey}, "Backslash", oxwm.client.toggle_floating())
...
oxwm.key.bind({ "Mod4", modkey }, "H", oxwm.set_master_factor(-5))
oxwm.key.bind({ "Mod4", modkey }, "L", oxwm.set_master_factor(5))
-- Increment/Decrement number of master windows
oxwm.key.bind({ "Mod4", modkey }, "I", oxwm.inc_num_master(1))
oxwm.key.bind({ "Mod4", modkey }, "P", oxwm.inc_num_master(-1))

-- Gaps toggle
oxwm.key.bind({ modkey,"Shift" }, "A", oxwm.toggle_gaps())

-- Focus movement [1 for up in the stack, -1 for down]
oxwm.key.bind({ modkey }, "Tab", oxwm.client.focus_stack(1))
oxwm.key.bind({ modkey , "Shift" }, "Tab", oxwm.client.focus_stack(-1))
...
oxwm.key.bind({ "Control" }, "1", oxwm.tag.view(0))
oxwm.key.bind({ "Control" }, "2", oxwm.tag.view(1))
oxwm.key.bind({ "Control" }, "3", oxwm.tag.view(2))
oxwm.key.bind({ "Control" }, "4", oxwm.tag.view(3))
oxwm.key.bind({ "Control" }, "5", oxwm.tag.view(4))
oxwm.key.bind({ "Control" }, "6", oxwm.tag.view(5))
oxwm.key.bind({ "Control" }, "7", oxwm.tag.view(6))
oxwm.key.bind({ "Control" }, "8", oxwm.tag.view(7))
oxwm.key.bind({ "Control" }, "9", oxwm.tag.view(8))
-- Move focused window to workspace N
oxwm.key.bind({ modkey}, "1", oxwm.tag.move_to(0))
oxwm.key.bind({ modkey}, "2", oxwm.tag.move_to(1))
oxwm.key.bind({ modkey}, "3", oxwm.tag.move_to(2))
oxwm.key.bind({ modkey}, "4", oxwm.tag.move_to(3))
oxwm.key.bind({ modkey}, "5", oxwm.tag.move_to(4))
oxwm.key.bind({ modkey}, "6", oxwm.tag.move_to(5))
oxwm.key.bind({ modkey}, "7", oxwm.tag.move_to(6))
oxwm.key.bind({ modkey}, "8", oxwm.tag.move_to(7))
oxwm.key.bind({ modkey}, "9", oxwm.tag.move_to(8))

-- Combo view (view multiple tags at once) {argos_nothing}
-- Example: Mod+Ctrl+2 while on tag 1 will show BOTH tags 1 and 2
oxwm.key.bind({ "Mod4", "Control" }, "1", oxwm.tag.toggleview(0))
oxwm.key.bind({ "Mod4", "Control" }, "2", oxwm.tag.toggleview(1))
oxwm.key.bind({ "Mod4", "Control" }, "3", oxwm.tag.toggleview(2))
oxwm.key.bind({ "Mod4", "Control" }, "4", oxwm.tag.toggleview(3))
oxwm.key.bind({ "Mod4", "Control" }, "5", oxwm.tag.toggleview(4))
oxwm.key.bind({ "Mod4", "Control" }, "6", oxwm.tag.toggleview(5))
oxwm.key.bind({ "Mod4", "Control" }, "7", oxwm.tag.toggleview(6))
oxwm.key.bind({ "Mod4", "Control" }, "8", oxwm.tag.toggleview(7))
oxwm.key.bind({ "Mod4", "Control" }, "9", oxwm.tag.toggleview(8))
...
oxwm.autostart("feh --bg-scale ~/Images/jaj.jpg") 
oxwm.autostart("redshift")
